...
namespace UnitTestProject1
{
    ...
    public class Unit4TestFactura
    {
        ...
        public static void Initialize(TestContext context)
        {
            try
            {
                //Insertar un empleado y usuarii para las pruebas
            ...
            try
            {
                ...
                cliente.Cedula_cliente = "0000000000";
        ...
        public void TM_1_Insertar_factura()
        {
            try
            {
                ...
                Empleado empleadoPrueba = eCtrl.getEmpleadoPorCedula("0000000000");
        ...
        public static void Cleanup()
        {
            ...
            clienteCtrl.eliminarCliente(clientePrueba.Id_cliente);
        }
    }
}
