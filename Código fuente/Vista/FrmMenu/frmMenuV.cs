...
namespace SistemaFacturacion.Vista.FrmMenu
{
    public partial class frmMenuV : Form
    {
        ...
        public static frmMenuV getSingleton(string user)
        {
            if (frmMenu == null)
            {
        ...
        private void frmMenuV_Load(object sender, EventArgs e)
        {
            ...
            rescalarIconosBotones(btnProvedores);
        ...
        {
            abrirFormulario(new frmListarProveedor ());

        }

        private void pnlSubmenus_Paint(object sender, PaintEventArgs e)
        {
