...
namespace SistemaFacturacion.Vista.Factura
{
    public partial class frmRegistrarFactura : Form
    {
        ...
        private void frmRegistrarFactura_Load(object sender, EventArgs e)
        {
            ...
            //Añadir al dto el usuario de la sesión activa
            facturaDto.Empleado = DatosSesion.Empleado;
        ...
        private void btnSeleccionarCliente_Click(object sender, EventArgs e)
        {
            ...
            {   
                txtCedulaCliente.Text = frmSeleccionar.Cliente_seleccionado.Cedula_cliente;
                txtNombresCliente.Text = $"{frmSeleccionar.Cliente_seleccionado.Nombres} {frmSeleccionar.Cliente_seleccionado.Apellidos}";

                facturaDto.Cliente = frmSeleccionar.Cliente_seleccionado;
            }
        }
        ...
        private void txtCedulaCliente_Leave(object sender, EventArgs e)
        {
            ...
            DTO.Cliente cliente = clienteCtrl.getClientePorCedula(txtCedulaCliente.Text);
        ...
        private void btnFacturar_Click(object sender, EventArgs e)
        {
            ...
            //Verificar que haya un usuario con la sesión activa
            if (facturaDto.Empleado == null)
            {
                Mensaje.advertencia("No hay ninguna sesión activa de empleado");
                return;
            }
            ...
            if(r.Completado)
            {
                ...
                this.Close();
                frmMenuV.getSingleton().abrirFormulario(new frmRegistrarFactura());
            }
            else
            {
        ...
        {
            //No permitir eliminar la fila si es la última
            if (e.Row.Index == dgvProductosFactura.RowCount - 1)            
            {
                e.Cancel = true;
                return;
            }

            //Remover el producto del detalle
            facturaDto.Factura_Detalle.RemoveAt(e.Row.Index);
        }

        private void txtProductoBuscar_KeyPress(object sender, KeyPressEventArgs e)
        {
