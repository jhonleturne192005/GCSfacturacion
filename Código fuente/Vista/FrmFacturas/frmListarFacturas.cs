...
namespace SistemaFacturacion.Vista.Factura
{
    public partial class frmListarFacturas : Form
    {
        ...
        private void actualizarBusqueda(int PAGINA_ACTUAL, int ELEMENTOS_PAGINA)
        {
            ...
            filtros.Add(new Filtros("fecha_inicio", dtpFechaInicio.Value.Date.ToString("MM-dd-yyyy")));
            filtros.Add(new Filtros("fecha_fin", dtpFechaFin.Value.Date.ToString("MM-dd-yyyy")));
